...
import 'diseno_credencial_repository.dart';
...
class Padron {
  ...
  /// Vetos: quiénes están observados por decisión de asamblea.
  late final VetoRepository vetos = VetoRepository(api);
